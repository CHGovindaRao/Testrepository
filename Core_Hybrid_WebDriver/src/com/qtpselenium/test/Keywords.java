...
public class Keywords {
	...
	private static Logger APP_LOGS = Logger.getLogger("devpinoyLogger");
...
public static String navigate(String object,String data){
	...
	public  String clickButton(String object,String data){
        ...
        try{
            driver.findElement(By.xpath(OR.getProperty(object))).click();
            Thread.sleep(Long.parseLong(object));
	...
	public  String writeInInputframe(String object,String data){
		APP_LOGS.debug("Writing in text box");
	...
	public  String writeIncontent(String object,String data){
		APP_LOGS.debug("Writing in text box");
	...
	public  String clickIncontent(String object,String data){
		APP_LOGS.debug("Writing in text box");
	...
	public  String clearcontent(String object,String data){
		APP_LOGS.debug("Writing in text box");
	...
	public void captureScreenshot(String filename, String keyword_execution_result) throws IOException{
		// take screen shots
		if(CONFIG.getProperty("screenshot_error").equals("N")){
			// capturescreen
